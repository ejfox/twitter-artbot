...
(function() {
  ...
  art.makeParticles = function() {
    var c, column, i, particleH, particleW, row, xpos, xposStart, ypos;
    console.log('Making ' + this.count + ' particles');
    this.tight = this.chance.bool();
    this.doubles = this.chance.bool();
  ...
  art.tick = function() {
    ...
    return this.data.forEach((function(_this) {
      return function(d, i) {
        ...
        d.angleStep += _this.chance.floating({
          min: -0.0001,
          max: 0.0001
        });
        ...
        if (_this.doubles) {
          _this.ctx.arc(d.y, d.x, d.radius / 2, 0, 2 * Math.PI);
