...
(function() {
  ...
  GenArt = (function() {
    ...
    GenArt.prototype.makeSimulation = function() {
      this.simulation = d3.forceSimulation().force('collide', d3.forceCollide(function(d) {
        return d.radius * 2;
      })).force('center', d3.forceCenter(this.width / 2, this.height / 2)).force('charge', d3.forceManyBody()).nodes(this.data);
