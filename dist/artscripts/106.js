  ...
  GenArt = (function() {
    ...
    GenArt.prototype.init = function(options, callback) {
      ...
      return colorLovers.get('/palettes', {
        keywords: this.chance.pickone(['dark', 'minimal', 'subtle', 'pop', 'shiny'], {
          sortBy: 'DESC',
          numResults: 1,
          orderCol: this.chance.pickone(['dateCreated', 'score', 'numVotes', 'numViews'])
        })
      }, (function(_this) {
    ...
    GenArt.prototype.makeParticles = function() {
      ...
      this.data = d3.range(this.count).map((function(_this) {
        return function() {
          ...
          return {
            x: _this.chance.pickone([0, _this.width, _this.width / 2]),
            y: _this.chance.pickone([0, _this.height, _this.height / 2]),
            color: _this.c10(i % 3),
            direction: direction,
            positions: [],
            radius: 2,
      ...
      return this.data.forEach((function(_this) {
        return function(d, i) {
          ...
          if (_this.chance.bool({
            ...
            _this.ctx.arc(d.y, d.x, 100, 0, Math.PI * 2, true);
          } else {
