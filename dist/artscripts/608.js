...
(function() {
  ...
  GenArt = (function() {
    function GenArt(seed) {
      ...
      this.count = 25;
      this.numTicks = 6000;
      this.linkCount = this.count * this.chance.floating({
        min: 0.5,
        max: 1.5,
        fixed: 2
      });
    ...
    GenArt.prototype.makeSimulation = function() {
      var alphaDecay, collideMult, collideStrength, distanceModifier, manyBodyStrength;
      ...
      distanceModifier = this.chance.floating({
        min: 0.4,
        max: 2,
        fixed: 2
      });
    ...
    GenArt.prototype.tick = function(callback) {
      var c, clampNum, gvx, gvy, noiseImpact, stepValue;
      this.ticks++;
      ...
      this.links.forEach((function(_this) {
        return function(d, i) {
          ...
          velocityMin = _this.chance.floating({
            min: 0.9,
            max: 4,
            fixed: 2
          });
          if (d.target.vx < -velocityMin || d.target.vx > velocityMin && d.target.vy < -velocityMin || d.target.vy > velocityMin) {
      ...
      this.ctx.stroke();
      noiseImpact = this.chance.floating({
        min: 0.9,
        max: 4
      });
      return this.data.forEach((function(_this) {
