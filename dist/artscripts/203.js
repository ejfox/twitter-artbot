...
(function() {
  ...
  GenArt = (function() {
    function GenArt(seed) {
      ...
      this.ctx.globalCompositeOperation = this.chance.pickone(['multiply', 'lightness'], this.ctx.fillStyle = 'white');
    ...
    GenArt.prototype.init = function(options, callback) {
      ...
      return colorLovers.get('/palettes', {
        keywords: this.chance.pickone(['vintage', 'neon', 'toy', 'cartoon', 'bright'], {
          sortBy: 'DESC',
          numResults: 1,
    ...
    GenArt.prototype.tick = function() {
      ...
      return this.data.forEach((function(_this) {
        return function(d, i) {
          var c, grd, grdEnd, moveUnit, randOffset;
          randOffset = _this.chance.integer({
            min: 2,
            max: 55
          });
          d.radius = d.radius - _this.chance.integer({
            min: 0,
            max: 2
          });
          d.radius = _.clamp(d.radius, 0, _this.width);
          ...
          d.color = c.toString();
          grdEnd = _this.chance.integer({
            min: 0,
            max: d.radius
          });
          grd = _this.ctx.createLinearGradient(0, 0, grdEnd, grdEnd);
