...
(function() {
  var Chance, T, Twit, argv, artScriptChoice, artScripts, canvasModule, chance, d3, d3Node, d3n, env, fs, rand, randGen, schedule, seed, tweetArt, tweetCron, uploadTweet;
  ...
  argv = require('yargs').alias('f', 'force').argv;

  artScripts = ['103', '104', '201', '503', '606', '607', '608', '703'];
  ...
  if (argv.force) {
    ...
    tweetCron = schedule.scheduleJob('20 * * * *', function() {
      return tweetArt();
    });
  }
