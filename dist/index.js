...
(function() {
  var Chance, T, Twit, argv, artScriptChoice, artScripts, canvasModule, chance, d3, d3Node, d3n, env, fs, makeMovie, rand, randGen, schedule, seed, tweetArt, tweetCron, uploadTweet;
  ...
  makeMovie = function() {
    ...
    art.init = function() {
      ...
      loopTicks = (function(_this) {
        return function() {
          _this.tick();
          return _this.saveFile('mov-' + t + '-' + _this.seed, function() {
            t++;
            if (t < tMax) {
              return loopTicks();
            } else {
