...
class GenArt
  constructor: (seed) ->
    ...
    @curveTho = @chance.floating {min: 0.8, max: 1.4, fixed: 2} #1.3
    @curveThe = 1.3
  ...
  makeSimulation: =>
    ...
    alphaDecay = @chance.floating {min: 0.0001, max: 0.09, fixed: 5}
    console.log 'alphaDecay: '+alphaDecay
    collideStrength = @chance.floating {min: 0.01, max: 1, fixed: 3}
    console.log 'collideStrength: '+collideStrength
    manyBodyStrength = @chance.floating {min: -130, max: 70, fixed: 3}
    console.log 'manyBodyStrength: '+manyBodyStrength

    distanceModifier = @chance.floating {min: 0.4, max: 2, fixed: 2}
